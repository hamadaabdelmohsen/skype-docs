...
- in coexistence with UCMA 3.0
- in coexistence with UCMA 2.0
...
|                  |Coexistence scenario |Migration scenario |Upgrade scenario |Direct deployment scenario (against Lync Server 2013) |
|------------------|---------------------|-------------------|-----------------|------------------------------------------------------|
|**UCMA 3.0**      |See UCMA 3.0 application on Lync Server 2010 with users on Lync Server 2013.  |See Migrating a UCMA 3.0 application &quot;as is&quot; to Lync Server 2013. |See Upgrading a UCMA 3.0 application to UCMA 4.0.  |See Deploying a UCMA 3.0 application against Lync Server 2013. |
|**UCMA 2.0**      |See UCMA 2.0 application on Communications Server 2007 R2 with users on Lync Server 2013.  |See Migrating a UCMA 2.0 application &quot;as is&quot; to Lync Server 2013. |See Upgrading a UCMA 2.0 application to UCMA 4.0 after coexistence. |See Deploying a UCMA 2.0 application against Lync Server 2013. |
...
Simply rebuild your UCMA 3.0 application using the UCMA 5.0 SDK. Watch for compiler warnings about the use of obsolete class members. For more information, see [Migration, coexistence, and upgrade of UCMA applications](migration-coexistence-and-upgrade-of-ucma-applications.md).
...
3. Run the **Move-CsApplicationEndpoint** cmdlet to update the contact object so that routing occurs through the Skype for Business Server 2015 Registrar. Use the –**Force** parameter.
    ...
    You'll need to run this cmdlet with the needed values for each contact object that your application uses.
...
5. Run the **Move-CsApplicationEndpoint** cmdlet to update the contact object so that routing occurs through the Skype for Business Server 2015 Registrar. Use the –**Force** parameter. You'll need to the following step with the needed values for each contact object that your application uses.
